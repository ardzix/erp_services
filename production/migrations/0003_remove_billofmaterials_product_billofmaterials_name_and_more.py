...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('production', '0002_alter_billofmaterials_approved_by_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='billofmaterials',
            name='name',
            field=models.CharField(blank=True, help_text='Name of this BoM', max_length=150, null=True),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(help_text='Select the component product', on_delete=django.db.models.deletion.CASCADE, to='inventory.product')),
