...
from .views.accounts_receivable import AccountsReceivableViewSet
...
router.register("accounts-receivable", AccountsReceivableViewSet,
                basename="accounts_receiveable")
