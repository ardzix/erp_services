...
class PayableFilter(django_filters.FilterSet):
    is_paid = django_filters.BooleanFilter(method='filter_is_paid',help_text=_('`true` for paid, `false` for unpaid'))
    supplier_id32 = django_filters.BooleanFilter(field_name='supplier__id32',help_text=_('Filter by supplier id32'))
    order_id32 = django_filters.BooleanFilter(field_name='order__id32',help_text=_('Filter by order id32'))
    invoice_id23 = django_filters.BooleanFilter(field_name='invoice__id32',help_text=_('Filter by invoice id32'))
