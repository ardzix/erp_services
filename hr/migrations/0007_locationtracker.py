...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('hr', '0006_alter_attendance_options_alter_department_options_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', django.contrib.gis.db.models.fields.PointField(blank=True, help_text='Coordinates where the employee located', null=True, srid=4326)),
                ...
                ('employee', models.ForeignKey(help_text='The employee being traked', on_delete=django.db.models.deletion.CASCADE, to='hr.employee')),
