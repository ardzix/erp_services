...
class Department(BaseModelGeneric):
    name = models.CharField(max_length=100, help_text=_("The name of the department"))
...
class Employee(BaseModelGeneric):
    user = models.OneToOneField(User, on_delete=models.CASCADE, help_text=_("The associated user of the employee"))
...
class Leave(BaseModelGeneric):
    employee = models.ForeignKey(Employee, on_delete=models.CASCADE, help_text=_("The employee who requested the leave"))
    leave_type = models.CharField(max_length=100, help_text=_("The type of leave"))
...
class Performance(BaseModelGeneric):
    employee = models.ForeignKey(Employee, on_delete=models.CASCADE, help_text=_("The employee being reviewed"))
    rating = models.PositiveIntegerField(choices=((1, _('Poor')), (2, _('Fair')), (3, _('Good')), (4, _('Very Good')), (5, _('Excellent'))), help_text=_("Rating given to the employee's performance"))
    review = models.TextField(blank=True, help_text=_("Additional review notes"))
