    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(help_text='Select the customer associated with the order', on_delete=django.db.models.deletion.CASCADE, related_name='customer_recievables', to='sales.customer')),
                ...
                ('invoice', models.ForeignKey(help_text='Select the invoice associated with the payment', on_delete=django.db.models.deletion.CASCADE, related_name='invoice_recievables', to='sales.invoice')),
                ('order', models.ForeignKey(help_text='Select the order associated with the item', on_delete=django.db.models.deletion.CASCADE, related_name='order_recievables', related_query_name='orderitem', to='sales.salesorder')),
